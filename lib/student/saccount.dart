                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          "123456", // Replace with actual register number
                          style: TextStyle(
                            fontSize: 16,
                        ...
                        const SizedBox(height: 8),
                        const Text(
                          "Computer Science", // Replace with actual department
                          style: TextStyle(
                            fontSize: 16,
                            color: Colors.white70,
                          ),
  ...
  void _showAboutDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text("About"),
        content: const Text(
          "This is the student profile page. You can view your details, deactivate your account, or logout from here.",
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
